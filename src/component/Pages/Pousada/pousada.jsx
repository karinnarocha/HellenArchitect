...
const Pousada = () => {
  return (
    <>
      <Hero
        image={Hero_Pousada[0]}
        title="Pousada"
        subtitle="Arquitetura e interiores para hospedagem, unindo conforto, identidade visual e experiência do hóspede em cada detalhe."
      />
      ...
      <div className="FinalCTAsection">
        <div className="FinalCTAcard">
          <h2 className="FinalCTAtitle">Vamos dar forma ao seu próximo empreendimento</h2>
          <p className="FinalCTAsubtitle">Projetos comerciais que unem identidade visual, conforto e retorno para o seu negócio.</p>
